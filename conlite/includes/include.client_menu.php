 ...
 *
 *   $Id: include.client_menu.php 312 2014-06-18 11:01:08Z oldperl $:
 * }}
 * 
 */
...
while ($db->next_record()) {
		...
		(strpos($auth->auth["perm"],"sysadmin") !== false))
	{
        ...
        if (!$classclient->hasLanguageAssigned($idclient) && $perm->have_perm_area_action('client',"client_delete") ) {
        	...
        	$delDescr = sprintf(i18n("Do you really want to delete the following client:<br><br>%s<br>"),clHtmlSpecialChars($db->f("name")));
